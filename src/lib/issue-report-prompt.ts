...
const PREAMBLES: Record<ReportCategory, string[]> = {
  bug: [
    ...
    "3. Start with a numbered section titled exactly `Issue 1: <short title>`. If the report contains multiple distinct bugs, requests, or product questions, add `Issue 2: <short title>` and so on.",
    "4. Note anything else the team should look at inside the relevant issue section.",
    "",
  ...
  feedback: [
    ...
    "3. Start with a numbered section titled exactly `Issue 1: <short title>`. If the feedback contains multiple distinct bugs, requests, or product questions, add `Issue 2: <short title>` and so on.",
    "4. Note anything else the team should weigh inside the relevant issue section.",
    "",
  ...
  feature: [
    ...
    "3. Start with a numbered section titled exactly `Issue 1: <short title>`. If the request contains multiple distinct bugs, requests, or product questions, add `Issue 2: <short title>` and so on.",
    "4. Note anything else the team should consider inside the relevant issue section.",
    "",
