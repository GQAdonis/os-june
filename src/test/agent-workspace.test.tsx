...
describe("AgentWorkspace", () => {
  ...
  it("generates an image from the /image slash command and renders it inline", async () => {
    const user = userEvent.setup();
    render(<AgentWorkspace />);
    expect(await screen.findByText("Existing session")).toBeInTheDocument();
    ...
    // The generated image lands as a composer attachment and renders inline
    // through the same chip path a pasted image uses.
