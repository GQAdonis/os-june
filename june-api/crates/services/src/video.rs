//! Metered video generation (ADR 0014). Video is Venice's asynchronous,
...
// --- Registry ----------------------------------------------------------------
//
// KNOWN BOUNDARY (ADR 0014 Decision 3): this registry is per-process memory. A
...
//
// Because jobs store handles, not bytes (ADR 0014 Decision 4), the caps bound
