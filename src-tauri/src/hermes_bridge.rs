...
fn sync_june_soul(
    ...
    let soul = if sandbox_available {
        ...
        format!(
            "{base}{JUNE_SOUL_CONTEXT_MD}{JUNE_SOUL_CLARIFY_MD}{JUNE_SOUL_WEB_MD}{JUNE_SOUL_IMAGE_MD}{video_section}{JUNE_SOUL_RECORDER_MD}{browser_section}{JUNE_SOUL_SANDBOX_MD}{cli_section}"
        )
    } else {
        format!("{base}{JUNE_SOUL_CONTEXT_MD}{JUNE_SOUL_CLARIFY_MD}{JUNE_SOUL_WEB_MD}{JUNE_SOUL_IMAGE_MD}{video_section}{JUNE_SOUL_RECORDER_MD}{browser_section}")
    };
...
"#,
    ...
    fn sync_june_soul_replaces_default_hermes_identity() {
        ...
        sync_june_soul(home.path(), true, false, false, true).expect("sync soul");
    ...
    fn june_soul_describes_local_context_tools() {
        ...
        sync_june_soul(home.path(), false, false, false, true).expect("sync soul");
    ...
    fn sandboxed_soul_with_cli_access_describes_the_grant() {
        ...
        sync_june_soul(home.path(), true, true, false, true).expect("sync soul");
    ...
    fn soul_with_browser_access_omits_the_request() {
        ...
        sync_june_soul(home.path(), true, false, true, true).expect("sync soul");
