...
`minimumReleaseAge` in `pnpm-workspace.yaml`; do not lower it or add
exclusions without a review-visible justification.
...
`minimumReleaseAgeExclude`; commit that change with the reason. New dependency
